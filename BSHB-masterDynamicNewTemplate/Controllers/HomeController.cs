...
namespace BiharStateHousingBoard.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //if (TempData["cnttimes"] == null)
            //{
            //    TempData["cnttimes"] = 1;
            //}
            //else
            //{
            //    TempData["cnttimes"] = int.Parse(TempData["cnttimes"].ToString())+1;
            //    TempData.Keep("cnttimes");
            //}
        ...
        public IActionResult ShowpopUp(int id)
        {
            var context = new DemoEntityContext();
                ...
                var pr = context.PressReleases.FirstOrDefault(x => x.Id == id);

            //specify the name or path of the partial view
            return PartialView("_PressDetail", pr);
        }
